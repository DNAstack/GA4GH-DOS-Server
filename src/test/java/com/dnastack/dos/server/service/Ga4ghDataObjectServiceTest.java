...
public class Ga4ghDataObjectServiceTest {
    ...
    @Test(expected = EntityNotFoundException.class)
    public void getObjectByIdAndAllVersionsTest() throws Exception {
    ...
    @Test
    public void updateObjectTest_pass() throws Exception {
    ...
    @Test(expected = EntityNotFoundException.class)
    public void updateObjectTest_fail_DNE() throws Exception {
